...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <!-- Panel con DefaultButton configurado -->
        <asp:Panel ID="panelForm" runat="server" DefaultButton="btnGuardar">
            ...
            <div id="datosSupervisor" runat="server" class="form-row">
                <div class="form-group">
                    <label for="codigo-cargo">Código cargo</label>
                    <asp:TextBox ID="txtCodigoCargo" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label for="agencia">Agencia asignada</label>
            ...
            <div id="containerBtn" runat="server" style="display: flex; gap: 10px;">
                ...
                <asp:Button ID="btnGuardar" runat="server" Text="Registrarse" CssClass="btn-login" OnClick="btnGuardar_Click" />
            </div>
        </asp:Panel>
    </div>
</asp:Content>
